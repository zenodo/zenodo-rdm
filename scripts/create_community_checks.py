...
from invenio_checks.models import CheckConfig, CheckRun, Severity
...
NASA_HELIO_RULES = {
    "rules": [
        ...
        # { MISSING: UI error handling on description field
        ...
        #     ],
        # },
        # { MISSING: UI error handling on subjects field
        #     "id": "subjects:length",
        ...
        #     ],
        # },
        # { # MISSING: 03myraf72 in the list of funders
        #     "id": "funding",
        ...
        },
        {
            ...
            "checks": [
                {
                    "type": "comparison",
                    "left": {"type": "field", "path": "custom_fields.code:codeRepository"},
                    "operator": "min",
                    "right": 1
                },
            ],
...
def create_metadata_checks(config, comm):
    ...
    if existing_check:  # If it exists, delete it first
        ...
        CheckRun.query.filter_by(config_id=existing_check.id).delete()
