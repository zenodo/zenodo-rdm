...
EU_RULES = {
    "rules": [
            ...
            "checks": [
                {
                    "type": "list",
                    "operator": "any",
                    "path": "relations.licenses",
                    "predicate": {
                        "type": "comparison",
                        "left": {"type": "field", "path": "props.osi_approved"},
                        "operator": "==",
                        "right": "y",
                    },
                }
        ...
        {
            "id": "creators:affiliation-identifiers",
            "title": "Affiliation Identifiers",
            "message": "All creator affiliations must have IDs",
            "description": "The EU curation policy suggests all creator affiliations should have identifiers",
            "level": "info",
            "condition": {
                "type": "list",
                "operator": "exists",
        ...
        {
            "id": "contributors:affiliation-identifiers",
            "title": "Affiliation Identifiers",
            "message": "All contributor affiliations must have IDs",
            "description": "The EU curation policy suggests all contributor affiliations should have identifiers",
            "level": "info",
            "condition": {
                "type": "list",
                "operator": "exists",
